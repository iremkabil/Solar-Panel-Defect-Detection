...
Kurulum ve kütüphane importları
Veri setinin Kaggle ortamında otomatik bulunması
Görüntü yollarının ve sınıf etiketlerinin hazırlanması
...
Grad-CAM / açıklanabilir yapay zeka görselleştirmesi
---
🧪 Veri Bölme
...
Kaggle'da:
Notebook'u aç.
Sağ panelden Add Data seçeneğine tıkla.
SPHERE veri setini ekle.
